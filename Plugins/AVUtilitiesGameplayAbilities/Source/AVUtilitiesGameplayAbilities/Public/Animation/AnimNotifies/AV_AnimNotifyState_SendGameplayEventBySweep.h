...
#include "AV_AnimNotifyState_SendGameplayEventBySweep.generated.h"
...
class AVUTILITIESGAMEPLAYABILITIES_API UAV_AnimNotifyState_SendGameplayEventBySweep : public UAnimNotifyState
{
	GENERATED_BODY()
...
private:
	...
	TArray<FHitResult> PerformSweep(USkeletalMeshComponent* MeshComp) const;
	void SendEventsToActors(TArray<FHitResult> Hits, const USkeletalMeshComponent* MeshComp) const;
