...
#define AV_LOG_UTILSGAS(Verbosity, Format, ...) UE_LOG(LogAV_UtilitiesGameplayAbilities, Verbosity, TEXT("%s: %s"), __FUNCTIONW__, *FString::Printf(TEXT(Format), ##__VA_ARGS__));
